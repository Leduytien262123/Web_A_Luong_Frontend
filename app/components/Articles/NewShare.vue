...
const shareToFacebook = () => {
  const urlToShare = `https://sim.wifi247.vn${route.path}`;
...
<template>
  <div class="lg:mt-10 mt-5">
    ...
    <div class="mt-1 flex items-center space-x-4">
      <!-- <SocialShare network="facebook"> </SocialShare> -->
      <NewShareFB @click="shareToFacebook" class="cursor-pointer" />
      <NewShareTwitter @click="shareToTwitter" class="cursor-pointer" />
      <NewSharePinterest @click="shareToPinterest" class="cursor-pointer" />
      <NewShareTelegram @click="shareToTelegram" class="cursor-pointer" />
      <NewShareInstagram @click="shareToInstagram" class="cursor-pointer" />
      <NewShareLinkedin @click="shareToLinkedIn" class="cursor-pointer" />
      <NewShareMessenger @click="shareToMessenger" class="cursor-pointer" />
    </div>
  </div>
</template>
